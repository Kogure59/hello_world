...
- AP サーバーを再度起動させた後のアクセス : 可
  ...
  ![PumaVersion](/images/images_lec03/puma_version.png)
  
  ![APStop](/images/images_lec03/apserver_stop.png)

  ![RailsApp](/images/images_lec03/railsapp.png)
...
- DB サーバーを終了させた後のアクセス : 不可
  ...
  ![SqlVersion](/images/images_lec03/sql_version.png)
  
  ![DBstop](/images/images_lec03/db_stop.png)
